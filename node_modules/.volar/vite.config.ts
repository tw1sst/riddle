// @ts-nocheck
import config from "/workspace/vite.config";
...
function __createAppProxy(...args) {
    ...
    window.__VOLAR_ENABLED__ = true;
    app.config.globalProperties.$volar = {
        highlight: (...args) => { window.$volar && window.$volar.highlight(...args) },
        unHighlight: (...args) => { window.$volar && window.$volar.unHighlight(...args) },
        vnodeMounted: (...args) => { window.$volar && window.$volar.vnodeMounted(...args) },
        vnodeUnmounted: (...args) => { window.$volar && window.$volar.vnodeUnmounted(...args) },
    };
