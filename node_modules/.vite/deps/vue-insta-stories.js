...
// node_modules/vue-insta-stories/node_modules/vue-demi/lib/index.esm.js
var isVue2 = false;

// node_modules/vue-insta-stories/dist/vue-insta-stories.esm.js
...
var h2 = function(type, options, chidren) {
  if (options === void 0) {
    options = {};
  }
  if (isVue2)
    return h(type, options, chidren);
    ...
    var loadeddata = function() {
      return __awaiter(_this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              this.$emit("action", "duration", this.vid.duration * 1e3);
              _a.label = 1;
            case 1:
              _a.trys.push([1, 3, , 4]);
...
var render = function(_a, $slots) {
  ...
  var attrs = { props: { story, isPaused }, on: { action: onAction } };
  ...
  return h2(getRender(type), attrs);
};
...
var Progress = defineComponent({
  ...
  render: function() {
    ...
    return h2("div", { class: "slice" }, [h2("div", { class: "progress", style })]);
  }
});
var Timeline = defineComponent({
  ...
  render: function() {
    ...
    var elements = this.stories.map(function(_, i) {
      ...
      var key = i;
      return h2(Progress, { key, props: { progress } });
    });
    return h2("div", { class: "timeline", ref: "timeline" }, elements);
  }
});
var WithSeeMore = defineComponent({
  ...
  render: function() {
    ...
    var seeMore = h2("div", { class: "see-more", on: events }, [
      h2("span", { class: "see-more-icon", style }, "^"),
      h2("span", { class: "see-more-text", style }, label)
    ]);
    return h2("div", { class: "see-more-wrapper" }, [
...
var wrapWithSeeMore = function(storyNode, options, action) {
  if (!options)
    return storyNode;
  var vnode = isVue2 ? [storyNode] : { default: function() {
    return storyNode;
  } };
  var label = options === true ? void 0 : options.label;
  return h2(WithSeeMore, { props: { label }, on: { action } }, vnode);
};
...
var Stories = defineComponent({
  ...
  render: function() {
    ...
    var renderProps = { story, onAction, isPaused: this.paused };
    var header = this.$slots.header;
    var storyVnode = render(renderProps, this.$slots);
    return h2("div", { ref: "stories", class: "vue-insta-stories", on: storiesEvents }, [
      h2(Timeline, __assign({ ref: "timeline" }, timelineProps)),
      header ? h2("div", { class: "header", ref: "header" }, slot(header, { story })) : null,
...
vue-insta-stories/dist/vue-insta-stories.esm.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=vue-insta-stories.js.map
